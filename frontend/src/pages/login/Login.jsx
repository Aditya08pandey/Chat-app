  ...
  return (
   <div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
                ...
                <form onSubmit={handleSubmit}>
					...
					<Link to='/signup' className='text-sm  hover:underline hover:text-black mt-2 inline-block  text-white'>
...
//                  <div>
//                     <button className='btn btn-block btn-sm mt-2  bg-black text-white hover:text-black'>Login</button>
//                 </div>
//               </form>
